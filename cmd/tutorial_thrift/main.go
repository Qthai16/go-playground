// copy from https://github.com/apache/thrift/tree/master/tutorial/go/src
...
func main() {
	...
	gw := flag.String("gw", "", "Thrift gateway address")
	...
	if *server {
		...
		if err := runClient(transportFactory, protocolFactory, *addr, *gw, *secure, cfg); err != nil {
